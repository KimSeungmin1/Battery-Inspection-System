...
본 프로젝트의 모델 학습에는 [AI-Hub](https://www.aihub.or.kr)의 **배터리 불량 이미지 데이터**를 사용하였습니다.  
This project uses the **Battery Defect Image Data** from [AI-Hub](https://www.aihub.or.kr) for model training.
